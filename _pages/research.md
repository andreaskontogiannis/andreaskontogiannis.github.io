...
**Equilibrium Computation in Markov Games**: Our goal is to study the computational complexity of equilibria in structured games, with a particular interest in *Markov games*; i.e., the game-theoretic framework capturing the setting of multi-agent reinforcement learning. The ultimate goal here is to identify the computational barriers of computing equilibria in such games and further explore settings where we can provably escape the PPAD-hardness inherent in general normal-form games.
